...
import { Box, Divider, Link as CLink, Heading, Text, UnorderedList, ListItem, Flex } from "@chakra-ui/react";
    ...
    <>
      ...
      <Box w={["100%", "70%"]} mx="auto" my="10">
        ...
        <Text py="5" fontSize="xl">
          Welcome to the module 202! In this page, you can create the code for miting with MeshJS. 
        </Text>
        <Text py="5" fontSize="xl">
        ...
        <Text pt="5" fontSize="xl">
          Now that you have it running, you can use this starter to complete the rest of the lessons in Module 202.
        </Text>
      </Box>
      <Divider w="70%" mx="auto" />
      <Box w={{ base: "100%", md: "90%", lg: "70%" }} mx="auto" my="5" p="5" border="1px" borderRadius="md" h="60">
