...
We will use this repository in Step 5. Run `cd ..` to get back to `/ppbl2023`. Then continue to Step 3.
...
### 5. Run `cabal repl` in the PPBL2023 Plutus Template, and write a validator
