...
In this lesson, we will focus on each of these commands, one at a time:
...
### "cardano-cli address build" can also be used to build a contract address!

In [Lesson 101.2](/modules/101/1012) we compared wallet addresses and contract addresses.
