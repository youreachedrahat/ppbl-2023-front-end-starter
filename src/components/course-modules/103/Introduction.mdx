...
<Grid templateColumns="repeat(2, 1fr)" gap={5}>
  <GridItem>
    ...
    <Text>Now that you have completed Modules 100 through 102, we'd like to tell you a bit more about PPBL 2023.</Text>
  </GridItem>
  <Center>
...
That's an example of learning by example.
...
In this course you will learn by doing things. Each Lesson shows you how to get started, and suggests ways for you to explore. Mastery Assignments push you to figure things out, and to discover new questions.

For example, in Module 102, there are two Mastery Assignments. Each one raises questions about proof, evidence and reputation, which are all considerations in the grand project of decentralized identity. What questions are you most curious about?
...
In this course you will work with real Projects. For example, in Module 100 you minted a PPBL 2023 Contributor token, and in Module 102, you built transactions with the token. Congratulations on being "Onboarded" to the PPBL 2023 Contributor Token project!

In the 200-Level Modules, we will "Build Background Knowledge" about how the Contributor Token works.
...
If PPBL 2023 is successful, it will help you find a way to contribute to a real project. There are many ways to contribute a project, and lots of projects are getting started on Cardano right now. Writing code and building systems will always be great ways to contribute to projects. This course will provide opportunities to practice doing both.
...
PPBL 2023 will introduce you to a variety of projects, and hope that you find at least one where you'd be excited to contribute. If you want to contribute here at Gimbalabs, we'd like to have you here! We'll also show you other places to contribute.
