  ...
  return (
    <Container maxWidth="80%" marginLeft="1em" marginTop="2em">
      ...
      <Text fontSize="xl" marginTop="1em">
        Welcome again to Plutus Project-Based Learning, or PPBL. Here is how this course works.
      </Text>
      ...
      <OrderedList margin="1em" marginLeft="3em">
        ...
        <ListItem fontSize="xl">
          The lessons in each module are designed to help you master each learning target.
        </ListItem>
        <ListItem fontSize="xl">You will complete projects to demonstrate mastery of the learning targets.</ListItem>
        <ListItem fontSize="xl">
          You can see your mastery status for each SLT in the top right corner of this page.
        </ListItem>
      </OrderedList>
